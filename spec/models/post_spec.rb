...
#I user context here instead of describe, is that an issue?
  context "voting" do
    before do
    ...
    describe "#down_votes" do
      it "counts the number of votes iwth value of = -1" do
  ...
  describe "upvote after_create" do
    it "upvotes the post after create" do
